...
<div class="container">
    <div class="row">
        ...
        <div class="col col-4 ">  <div class="card rounded bg-primary  text-deuxieme p-2 shadow" style="opacity: 0.8" >
            ...
            <div class="h3 p-2 text-light    d-flex align-self-center"> المجمــوعــات   </div>
            ...
            <a href="/crenau" class=" text-deuxieme m-4 p-2 btn btn-dark  btn d-flex align-self-center">تصفح الجميع</a>
             </div>
            </div>
    </div>
</div>
