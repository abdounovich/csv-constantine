       ...
       <div class="container  ">
            <div class="row ">
              <div class="col p-4 btn-group">
                <a class=" col col-2 text-white btn btn-primary m-2 p-2 " style="font-size: 60px" title="الرئيسية"   href="/registrations"><i class=" p-2 fa fa-home"></i> </a>
            ...
            <a href="/creneau" class=" col col-2 text-white btn btn-primary m-2 p-2" title="الأفواج" style="font-size: 60px"><i class=" p-2 fa fa-calendar-check-o"></i></a>
